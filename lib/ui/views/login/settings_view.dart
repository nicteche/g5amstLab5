...
class _Settings extends State<Settings> {
  ...
  ListView _formItems() {
    return ListView(
      children: [
        FormItem(text: "nicteche@espol.edu.ec",label: "Email", hintText: "Ingrese su email",),
        FormItem(text: "Nicholas Echeverria",hintText: "Nombre", label: "Ingrese su nombre",),
        FormItem(text: "0978759499",label: "Celular", hintText: "Ingrese su celular",),
